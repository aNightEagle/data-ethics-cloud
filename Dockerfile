...
ARG JAVA_OPTS="-server -Xms1G -Xmx1G -Xss256k -XX:MetaspaceSize=128m -XX:MaxMetaspaceSize=128m -XX:+UseParallelOldGC -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=dump.log -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -Xloggc:${BASE_PATH}/logs/gc.log -XX:NewSize=512M -XX:MaxNewSize=512M"
